...
<body>
	...
	<p style="text-align:center;color:white;">You can search Vehicle by their RTO CODE</p>
	<div class="navbar">
	...
	<a class="active" href="${pageContext.request.contextPath}/getbyRTOCODE"><i class="material-icons" style="font-size:23px">event_seat</i><span style="font-size:20px"> Show Vehicle by RTO CODE</span></a>
