...
<body>
   ...
   <a class="active" href="${pageContext.request.contextPath}/search"><i class="material-icons" style="font-size:23px">search</i><span style="font-size:20px"> Search Vehicles</span></a>
	...
	<p style="text-align:center;color:white;">You can search Vehicle by their RTO COUNT</p>
	<div class="navbar">
	...
	<a href="${pageContext.request.contextPath}/getbyStatusCode"><i class="material-icons" style="font-size:23px">font_download</i><span style="font-size:20px"> Show Vehicle by State Code</span></a>
	...
	<a class="active" href="${pageContext.request.contextPath}/getbyRTOCount"><i class="material-icons" style="font-size:23px">ondemand_video</i><span style="font-size:20px"> Show Vehicle by RTO Count</span></a>
</form>
</div>
	<div id="addVehicle" align='center'>

		<form action="/getbyRTOCount" method="post">
			<p>
     			<label>Enter RTO Count</label>

				<input type="text" name="RTO_Count" />
			</p>
