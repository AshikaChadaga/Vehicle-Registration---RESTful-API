...
<body>
   ...
   <a class="active" href="${pageContext.request.contextPath}/search"><i class="material-icons" style="font-size:23px">search</i><span style="font-size:20px"> Search Vehicles</span></a>
	...
	<p style="text-align:center;color:white;">You can search Vehicle by their Type</p>
	<div class="navbar">
	...
	<a class="active" href="${pageContext.request.contextPath}/getbyVType"><i class="material-icons" style="font-size:23px">attach_money</i><span style="font-size:20px"> Show Vehicle by Type</span></a>
