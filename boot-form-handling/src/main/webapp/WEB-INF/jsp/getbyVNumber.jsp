...
<body>
   ...
   <a class="active" href="${pageContext.request.contextPath}/search"><i class="material-icons" style="font-size:23px">search</i><span style="font-size:20px"> Search Vehicles</span></a>
	...
	<p style="text-align:center;color:white;">You can search Vehicle by their Vehicle Number</p>
	<div class="navbar">
	<form action="/search" method="post">	
    <a class="active" href="${pageContext.request.contextPath}/getbyVNumber"><i class="material-icons" style="font-size:23px">assignment_ind</i><span style="font-size:20px"> Show Vehicle by Vehicle Number</span></a>
